...
require_once plugin_dir_path( __FILE__ ) . 'includes/apis/class-bawbin-maps-federated-imaps-api.php';//Federated Bawbab Imaps REST API endpoints
...
//=========================================
require_once plugin_dir_path( __FILE__ ) . 'includes/shortcodes/class-bawbin-map-shortcode.php';//Main interactive map shortcode registration
...
function bawbin_maps_create_block_bawbab_interactive_maps_block_init() {
    if ( function_exists( 'wp_register_block_types_from_metadata_collection' ) ) {
        wp_register_block_types_from_metadata_collection( __DIR__ . '/build', __DIR__ . '/build/blocks-manifest.php' );
    }
}
add_action( 'init', 'bawbin_maps_create_block_bawbab_interactive_maps_block_init' );
...
if ( file_exists( plugin_dir_path( __FILE__ ) . 'includes/bawbin-maps-hook-global-assets.php' ) ) {
    require_once plugin_dir_path( __FILE__ ) . 'includes/bawbin-maps-hook-global-assets.php';
}
...
// add_action( 'admin_notices', 'bawbin_maps_display_current_screen_id' );
// functionbawbin_maps_display_current_screen_id() {
