 ...
 * File: includes/apis/class-bawbin-maps-federated-api.php
 */
...
class BAWBIN_Maps_Federated_API_Controller {
    ...
    private function bawbin_maps_load_dependencies() {
        ...
        require_once $api_dir . 'class-bawbin-maps-rest-exporter.php';
        require_once $api_dir . 'class-bawbin-maps-rest-settings.php';
    }
    ...
    public function bawbin_maps_register_all_routes() {
        ...
        BAWBIN_Maps_REST_Exporter::bawbin_maps_register_routes( self::NAMESPACE );
        BAWBIN_Maps_REST_Settings::bawbin_maps_register_routes( self::NAMESPACE );
    }
