...
import { __experimentalText as Text, TextareaControl, SelectControl, PanelBody, Flex, FlexItem, TextControl, Button } from '@wordpress/components';

export const MapsTab = ({ 
    mapDescription, setMapDescription, 
    mapType, setMapType, 
    googleApiKey, setGoogleApiKey, 
    googleMapId, setGoogleMapId 
}) => {
    ...
    return (
        <div className="tab-content">
            <Text variant="title.small" display="block" style={{ marginBottom: '15px' }}>
                {__('Global Map Details & Provider Settings', 'bawbab-interactive-maps')}
            </Text>

            {/* --- MAP DESCRIPTION --- */}
            <TextareaControl 
                label={__('Main Map Description', 'bawbab-interactive-maps')} 
            ...
            <PanelBody title={__('Google Maps API Credentials', 'bawbab-interactive-maps')} style={{ marginTop: '20px' }}>
                {/* API KEY INPUT */}
