...
export const MapLegendManager = ( {
    ...
    // Set of categories already merged into existing lines
    ...
    const handleRemoveSection = ( secId ) => {
        setLegendConfig( ( prev ) => {
            ...
            const targetSec = currentSections.find( ( s ) => s.id === secId );
            ...
            // Move orphan items into the first remaining section
            if ( targetSec.items.length > 0 && remainingSections.length > 0 ) {
    ...
    // 6. Transfer Item to Different Section
                                ...
                                >
                                    ...
                                    <div style={ { borderBottom: '1px solid #eee' } }>
                                        ...
                                        >
                                            ...
                                            <span>
                                                { __( 'Legend Label', TEXT_DOMAIN ) }
                                            </span>
                                            <span>
                                                { __( 'Move to Section', TEXT_DOMAIN ) }
                                            </span>
                                            <span>
                                                { __( 'Swatches', TEXT_DOMAIN ) }
                                            </span>
                                            <span style={ { textAlign: 'center' } }>
