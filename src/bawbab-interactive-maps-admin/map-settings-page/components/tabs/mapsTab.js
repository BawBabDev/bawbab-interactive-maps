        ...
        <div className="tab-content">
            ...
            <div style={ { marginBottom: '16px' } }>
                <TextControl
                    ...
                    placeholder={ __( 'e.g. Interactive Campus Map', 'bawbab-interactive-maps' ) }
                    maxLength={ TITLE_MAX }
                ...
                <Text
                    variant="caption"
                    color="#888"
                    style={ { marginTop: '4px', display: 'block', textAlign: 'right', fontSize: '11px' } }
                >
                    { sprintf(
                        __( '%d / %d characters', 'bawbab-interactive-maps' ),
                        ( mapTitle || '' ).length,
                        TITLE_MAX
                    ) }
                </Text>
