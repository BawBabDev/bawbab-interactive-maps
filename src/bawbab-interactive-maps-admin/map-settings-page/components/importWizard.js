...
export const GeoJSONImportWizardModal = ( {
    ...
    const [ customSelections, setCustomSelections ] = useState( {} ); // { key: boolean }
    const [ customTypes, setCustomTypes ] = useState( {} );           // { key: 'text'|'number'|'boolean'|'dual_counter' }
    ...
    const handleCustomTypeChange = ( propKey, newType ) => {
        setCustomTypes( ( prev ) => ( {
            ...prev,
            [ propKey ]: newType,
        } ) );
                                    ...
                                    >
                                        <FlexItem style={ { flex: '0 0 220px' } }>
                                            <CheckboxControl
                                                ...
                                                onChange={ ( checked ) =>
                                                    handleStandardToggle( field.key, checked )
                                                }
                                                ...
                                                { ! isAuto && (
                                                    <div style={ { flex: 1 } }>
                                                        <SelectControl
                                                            ...
                                                            disabled={ ! isChecked }
                                                            onChange={ ( val ) =>
                                                                handleStandardChange( field.key, val )
                                                            }
                                                            __nextHasNoMarginBottom
                                                        />
                                                    </div>
                                                ...
                                                <CheckboxControl
                                                    label={
                                                        <span>
                                                            ...
                                                            >
                                                                { sampleVal !== undefined ? `(e.g. "${ sampleVal }")` : '' }
                                                            </span>
                                                        </span>
                                                    }
                                            ...
                                            <FlexItem style={ { width: '160px' } }>
                                                <div className="select-control-wrapper">
                                                    <SelectControl
                                                        ...
                                                        onChange={ ( newType ) => handleCustomTypeChange( key, newType ) }
                                                        style={ {
                                                            height: '28px',
                                                            minHeight: '28px',
                                                            lineHeight: '28px',
