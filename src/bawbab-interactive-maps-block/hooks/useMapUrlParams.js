 ...
 */
export const useMapUrlParams = (spatialFeatures, setActiveFloor, setSelectedLocation, setIsDrawerOpen) => {
    useEffect(() => {
        ...
        if ((unitParam || locationParam) && spatialFeatures.length > 0) {
            ...
            if (feature) {
                ...
                setSelectedLocation({ ...feature.properties, geometry: feature.geometry, type: 'spatial' });
                setIsDrawerOpen(true);
            }
        }
    }, [spatialFeatures, setActiveFloor, setSelectedLocation, setIsDrawerOpen]);
};
